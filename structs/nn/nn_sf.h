...
struct nn::sf::detail::CmifProxyInfo {
  struct nn::sf::detail::CmifProxyInfo::vtable *__vftable;
  s32 unk_08;
};

struct nn::sf::detail::CmifProxyInfo::vtable
{
  void* get_proxyBase(nn::sf::detail::CmifProxyInfo*);
};

struct nn::sf::hipc::client::Hipc2ClientProxyBaseObject
{
  s16 unk_00;
  s32 unk_04;
};
